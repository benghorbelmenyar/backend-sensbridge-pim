...
let EmergencyContact = class EmergencyContact extends mongoose_2.Document {
    userId;
    name;
    phone;
};
...
exports.EmergencyContactSchema.index({ userId: 1 });
//# sourceMappingURL=emergency-contact.schema.js.map